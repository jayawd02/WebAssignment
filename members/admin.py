...
class MemberAdmin(admin.ModelAdmin):
    fields =['user','first_name','last_name','gender','date_of_birth','height','address_line1','address_line2','email','contact_no1','contact_no2','health_problems','allergies','meal_preference']
