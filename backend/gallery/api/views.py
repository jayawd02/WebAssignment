...
from gallery.models import Post, Video, Recipe, PostComment, PostDislike, PostLike, Article
from .serializers import PostSerializer, VideoSerializer, RecipeSerializer, PostCommentSerializer, PostLikeSerializer, \
    PostDislikeSerializer, ArticleSerializer
